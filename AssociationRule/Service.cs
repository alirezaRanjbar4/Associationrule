namespace AssociationRule
{
    ...
    {
        public List<AprioriResult> MineAssociationRules(List<List<string>> transactions, int minSupport = 10, double minConfidence = 0.5)
        {
            ...
            return associationRules.Select(x => new AprioriResult()
            {
                Confidence = x.Item3,
